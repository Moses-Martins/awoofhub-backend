...
@Get('offer/:offerId')
@ApiOperation({ summary: 'Get all comments for an offer' })
...
@UseGuards(AuthGuard)
@ApiBearerAuth()
@ApiOperation({ summary: 'Create comment for an offer' })
@ApiParam({ name: 'offerId', type: String, description: 'Offer ID', example: '64f8c2d9a12b3c0012345678' })
...
return this.commentsService.findAllGlobal(search, createdFrom, createdTo, page, limit);
}

@Get(':id')
@ApiOperation({ summary: 'Get comment by ID' })
@ApiParam({ name: 'id', type: String, description: 'Comment ID', example: '64f8c2d9a12b3c0012345678' })
