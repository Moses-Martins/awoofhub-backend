export function resetPasswordEmailTemplate(data: {
    name: string;
    token: string;
    frontendUrl: string;
}) {
...
<html lang="en">
  <head>
    ...
    <title>Reset your password - AwoofHub</title>
    <style>
      ...
      <tr>
        <td align="center">
          <table class="email-container" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td class="email-body">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="btn-cell">
                      <p class="verify-text">Click the button to reset:</p>

                      <a class="email-button"
                         href="${data.frontendUrl}/reset-password?token=${data.token}">
                        Reset Password
                      </a>
                    </td>
                  </tr>
            ...
            <tr>
              <td class="footer">
                <img src="https://pub-24c34059b34943d1a950bfdb90169a52.r2.dev/media/LogoWhite.png"
                     alt="AwoofHub Logo"
                     width="150">
              </td>
            </tr>
